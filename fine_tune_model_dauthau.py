...
if __name__ == "__main__":
    ...
    train_dataset_file = f'data_rag/vibilaw/train_dataset.json'
    val_dataset_file = f'data_rag/vibilaw/val_dataset.json'
    test_dataset_file = f'data_rag/vibilaw/test_dataset_v3.json'
  
    output_base_dir = f'results/results_vibilaw'
