...
model_params = {
    "keepitreal/vietnamese-sbert": (0.5, 0.3),
    "VoVanPhuc/sup-SimCSE-VietNamese-phobert-base": (0.5, 0.4),
    "bkai-foundation-models/vietnamese-bi-encoder": (0.4, 0.5),
    "hmthanh/VietnamLegalText-SBERT": (0.4, 0.4),
    "BAAI/bge-base-en-v1.5": (0.5, 0.3),
    "BAAI/bge-small-en-v1.5": (0.2, 0.2),
    "colbert-ir/colbertv2.0": (0.5, 0.4),
    "FPTAI/vibert-base-cased": (0.3, 0.4),
    "vinai/phobert-large": (0.3, 0.3),
    "vinai/phobert-base": (0.5, 0.2)
}
...
if __name__ == "__main__":
    ...
    train_dataset_file = f'../data_rag/coling2020/train_dataset.json'
    val_dataset_file = f'../data_rag/coling2020/nval_dataset.json'
    test_dataset_file = f'../data_rag/coling2020/test_dataset.json'
  
    output_base_dir = f'results/results_coling'
